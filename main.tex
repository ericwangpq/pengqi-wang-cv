    ...
    \section{Education}
        ...
        \begin{onecolentry}
            \begin{highlights}
                ...
                \item Thesis Topic: Comp. Study of Tree-Based \& Transformer-based Models for Fake Rev. Detection on Yelp
...
\newpage
    ...
    \section{Selected Research Experiences}
        ...
        \textit{Sep 2023 – Present}}
            ...
            \textit{Accessible \& Pervasive User EXperience (APEX) Lab, HKUST, Supervised by Prof. Mingming FAN}
        \end{twocolentry}
        ...
        \begin{twocolentry}{
            \textit{Jul 2022 – Present}}
                ...
                \textit{Faculty of Business and Management, HKBU-UIC (Supervised by Prof. May Ying WANG)}
        \end{twocolentry}
